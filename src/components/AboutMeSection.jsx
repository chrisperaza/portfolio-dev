    ...
    <section className='aboutMe-section'>
      <section className='aboutMe-infoSection'>
        ...
        <p className='aboutMe-infoSection-text'>
          ...
          design, which is why I want to become a web developer. <br /> <br />{' '}
          My goal is to design and develop web applications that provide
          exceptional user experiences and facilitate or support specific tasks.
        </p>
        <SocialMediaList />
